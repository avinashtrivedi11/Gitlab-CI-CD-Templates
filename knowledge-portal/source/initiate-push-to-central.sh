...
# Run python script for pipeline checks
output=$(python3 -c "$(curl -fsSL https://github.com/avinashtrivedi11/Gitlab-CI-CD-Templates/raw/python-solution/knowledge-portal/source/pipeline-checks.py)")
