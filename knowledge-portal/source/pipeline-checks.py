...
def check_for_folders(source_paths):
    ...
    for source_path in source_paths:
        ...
        if os.path.exists(source_path):
            ...
            sys.exit(f"Check failed! This file/folder: {source_path} mentioned in manifest file doesn't exist.")
...
with open(manifest_file, 'r') as f:
    ...
    # To be done: Read all .md files and check if any image assets need to be copied over to central
